...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if($_SESSION["operation"]=="DELETE") {
        ...
        $accountCRUDModel->delete($_SESSION["id"]);
        header("list.php");
    }
    if($_SESSION["operation"]=="EDIT") {
        ...
        echo "I am here...";
        $accountCRUDModel = new model\AccountCRUDModel();
        $columnNames = array("username","email","fname","lname","phone","birthday","gender","password");
        $columnValues = array("carolis","carolis@njit.edu","Carolis","Jonathan","908-798-9088","2009-03-23","male","carolis32");
        $accountCRUDModel->insert($columnNames,$columnValues);
